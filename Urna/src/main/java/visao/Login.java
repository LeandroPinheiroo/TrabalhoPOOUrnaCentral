...
public class Login extends javax.swing.JFrame {
     ...
     * @version 4.0
     */
    public Login(VotoDao votoDao, Integer atualizar, ArrayList<Eleitor> eleitoresVotou) {
    ...
    /**
     * Método para baixar os dados do arquivo de eleitores do GDrive, e criar um
     * arquivo local com esses dados
     *
     * @author João Paulo e Leandro
     * @version 4.5
     */
    ...
    /**
     * Método para baixar os dados do arquivo de candidatos e coloca-los em um
     * arquivo local
     *
     * @author João Paulo e Leandro
     * @version 4.5
    ...
    /**
     * Método para baixar os dados do arquivo de partidos do GDrive e coloca-los
     * em um arquivo local
     *
     * @author João Paulo e Leandro
     * @version 4.5
    ...
    /**
     * Método para comparar os dados da matriz imagem recebida no login, e a
     * cadastrada no eleitor e verificar se são realmente iguais
     *
     * @author João Paulo e Leandro
    ...
    /**
     * Método para validar o login do eleitor, e permiter a conexão com o
     * sistema
     *
     * @author João Paulo e Leandro
    ...
    /**
     * Método para pegar o arquivo de Candidatos, e jogar os dados em um
     * arraylist
     *
     * @author João Paulo e Leandro
    ...
    private void botaoEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoEntrarActionPerformed
        if (verificaLogin()) {
            for (Eleitor eleitor : eleitoresVotou) {
                if (eleitor.getCpf().equals(this.eleitor.getCpf())) {
                    JOptionPane.showMessageDialog(this, "Atenção o eleitor ja efetuou seu voto e não é permitido votar mais de uma vez", "Erro ao tentar votar", JOptionPane.ERROR_MESSAGE);
                    return;
                }
            }
            new VotacaoDeputado(this.candidatos, this.partidos, eleitor, votoDao,eleitoresVotou).setVisible(true);
            this.dispose();
        }
