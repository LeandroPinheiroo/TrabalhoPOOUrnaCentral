 ...
 */
public class VotacaoDeputado extends javax.swing.JFrame {

    /**
     * Creates new form VotacaoPresidente
     */
    ...
    Candidato candidato;
    VotoDao votoDao;
    ArrayList<Eleitor> eleitoresVotou;
     ...
     * @version 1.0
     */
    public VotacaoDeputado(ArrayList<Candidato> candidatos, ArrayList<Partido> partidos, Eleitor eleitor, VotoDao votoDao,ArrayList<Eleitor> eleitoresVotou) {
        initComponents();
        this.setTitle("Urna");
        ...
        this.eleitoresVotou = eleitoresVotou;
        setPropriedades();
    }

    /**
     * Método para pegar os dados de um candidato de acordo com o número dele e
     * jogar nos campos do frame
     *
     * @author João Paulo e Leandro
        ...
        if (!this.candidatos.isEmpty()) {
            for (Candidato candidato : this.candidatos) {
                if (candidato != null) {//caso candidato nao seja null
                    ...
                    if (candidato instanceof Deputado) {
                        if (candidato.getNumero() == numero && ((Deputado) candidato).getEstado().equals(eleitor.getEstado())) {
                            ...
                            campoEstado.setText(((Deputado) candidato).getEstado());
    ...
    private void initComponents() {
        ...
        campoPresidente.setText("Deputado Federal");
        campoPresidente.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                campoPresidenteActionPerformed(evt);
            }
        });
        ...
        campoEstado.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N
    ...
    private void botaoBrancoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoBrancoActionPerformed
        ...
        this.limparCampos();
        new VotacaoPresidente(this.candidatos, this.partidos, eleitor, votoDao,this.eleitoresVotou).setVisible(true);
        this.dispose();
    ...
    private void campoPresidenteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_campoPresidenteActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_campoPresidenteActionPerformed
