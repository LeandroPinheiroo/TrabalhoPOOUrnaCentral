 ...
 */
public class VotacaoPresidente extends javax.swing.JFrame {
     ...
     * @version 1.0
     */
    public VotacaoPresidente(ArrayList<Candidato> candidatos, ArrayList<Partido> partidos, Eleitor eleitor, VotoDao votoDao, ArrayList<Eleitor> eleitoresVotou) {
        initComponents();
        this.setTitle("Urna");
        ...
        if (!this.candidatos.isEmpty()) {
            for (Candidato candidato : this.candidatos) {
                if (candidato != null) {//caso candidato nao seja null
                    ...
                    if (candidato.getNumero() == numero && candidato instanceof Presidente) {
    ...
    private void botaoBrancoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoBrancoActionPerformed
        ...
        this.limparCampos();
        this.eleitoresVotou.add(eleitor);
        this.dispose();
