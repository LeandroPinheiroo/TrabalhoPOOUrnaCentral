...
public class CadastraEleitor extends javax.swing.JFrame {
    ...
    /**
     * Metodo reponsavel gerar um novo eleitor com base nas informacoes
     * recebidas nos inputs
     *
     * @return Eleitor, um objeto de eleitor contendo todas as informacoes do
     * mesmo
     * @version 1.0
     */
    public Eleitor novoEleitor() {
        ...
        eleitor.setEstado(jComboEstado.getSelectedItem().toString());
    ...
    public void limparCampos() {
        ...
        this.fileName.setText("");
        this.jComboEstado.setSelectedIndex(-1);
    }
    ...
    public String validaEleitor() {
        ...
        if (jComboEstado.getSelectedIndex() == -1) {
            erros += "Insira o estado do eleitor\n";
        }
