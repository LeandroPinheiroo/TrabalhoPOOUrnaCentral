 ...
 */
public class CadastraPresidente extends javax.swing.JFrame {

    /**
     * Creates new form CadastraPresidente
     */
     ...
     *@version 4.0
     */
    public CadastraPresidente(CandidatoDao candidatoDao, PartidoDao partidoDao) {
        ...
        this.setTitle("Cadastra Presidente");//coloca Titulo
    ...
    public String validaCandidato() {
        ...
        if (jtfNome.getText().equals("")) {
            erros += "Insira o nome do presidente\n";
        }
        if (jtfNumero.getText().equals("")) {
            erros += "Insira o número do presidente\n";
        }
        if (jComboPartido.getSelectedIndex() == -1) {
            erros += "Insira o partido do presidente\n";
        }
        if (jCpf.getText().equals("   .   .   -  ")) {
            erros += "Insira o CPF do presidente\n";
            return erros;
        }
     ...
     *@version 1.0
     */
    public Presidente novoPresidente() {
        Presidente presidente = new Presidente();
        presidente.setCpf(jCpf.getText());
        presidente.setNome(jtfNome.getText());
        presidente.setNumero(Integer.parseInt(jtfNumero.getText()));
        presidente.setPartido(this.partidoDao.retornaPartido(jComboPartido.getSelectedItem().toString()));
        return presidente;
    }
    ...
    private void initComponents() {
        ...
        jlabelEleitor.setText("Presidente");
    ...
    private void ButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonCadastrarActionPerformed
        ...
        if (!erro.equals("")) {
            JOptionPane.showMessageDialog(this, erro, "Erro ao cadastrar Presidente", JOptionPane.ERROR_MESSAGE);
            return;
        }
        candidatoDao.cadastraCandidato(this.novoPresidente());
        JOptionPane.showMessageDialog(this, "Presidente cadastrado com sucesso", "Presidente Cadastrado", JOptionPane.INFORMATION_MESSAGE);
        this.limparCampos();
